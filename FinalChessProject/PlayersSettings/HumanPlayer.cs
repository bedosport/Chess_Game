...
namespace FinalChessProject.PlayersSettings
{
    ...
    public abstract class HumanPlayer
    {
        ...
        public abstract List<Piece> getActivePlayerPieces(Board board);
        public abstract List<Move>  getActivePlayerMoves(Board board, List<Piece> playerPieces);
        public abstract bool kingInCheck(Tuple<int,int> currentPlayerKingPosition,List<Move> enemyLegalMoves);
    }
    public class WhitePlayer : HumanPlayer
    {
        public WhitePlayer()
        {
        ...
        public override List<Move> getActivePlayerMoves(Board board, List<Piece> playerPieces)
        {
        ...
        public override List<Piece> getActivePlayerPieces(Board board)
        {
